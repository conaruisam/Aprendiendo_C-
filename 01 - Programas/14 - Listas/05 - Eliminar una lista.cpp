...
void menu(){
	...
	do{
		...
		cout<<"5. Dejar vacia la listo en la lista\n";
		cout<<"6. Salir";
		cout<<"\nOPCION: ";
		 cin>>opcion;
...
void eliminarLista(Nodo *&lista, int &n) {
	...
	Nodo *aux = lista;  // Se crea una variable auxiliar
	n = aux->dato;     // Indicamos el dato a borrar
	lista = aux->siguiente; // Modificamos la lista original y la pasamos al valor siguiente.
	delete aux;	// Borramos el registro..
}
